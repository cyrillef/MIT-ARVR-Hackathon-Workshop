...
* Using git
  ...
  - Fork the project
  - Copy your fork URL, e.g. `https://github.com/myusername/MIT-ARVR-Hackathon-Workshop`
  - Clone your fork locally to a new directory. If no directory name is specified, the repository name is used:
  ```
  git clone https://github.com/myusername/MIT-ARVR-Hackathon-Workshop.git
  ```
  - Enter the new directory:
  ```
  cd MIT-ARVR-Hackathon-Workshop
  ```
...
The tutorial instructions, from now on, assume you are running all commands from the *MIT-ARVR-Hackathon-Workshop* directory
